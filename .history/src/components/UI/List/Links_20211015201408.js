          ...
          <ul className={classes.li} key={Math.random()}>
            <li ref={this.linkRef}>
              <a
                ...
                id={link._id}
                value={link.cliced} // вот это место очень непонятное, я просто не знал какой property использовать у тега <a> для передачи NUMBER и использовал elementTiming
              >
